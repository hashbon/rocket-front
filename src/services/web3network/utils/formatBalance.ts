...
export const getBalanceAmount = (amount: BigNumber, decimals = 18) => new BigNumber(amount.toString()).dividedBy(BIG_TEN.pow(decimals));
...
export const getFullDisplayBalance = (balance: any, decimals = 18, displayDecimals = 0) => getBalanceAmount(balance, decimals).toFixed(displayDecimals, BigNumber.ROUND_FLOOR);
